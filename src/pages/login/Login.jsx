...
function Login() {
  ...
  return (
    <div className="relative flex h-full items-center justify-center overflow-auto px-1 py-2">
      <div className="w-full sm:w-1/2">
        <div className="absolute left-1/2 top-1/2 z-10 mx-auto flex w-11/12 translate-x-[-50%] translate-y-[-50%] items-center justify-center rounded-xl bg-white bg-opacity-90 sm:static sm:w-full sm:translate-x-[0] sm:translate-y-[0]">
